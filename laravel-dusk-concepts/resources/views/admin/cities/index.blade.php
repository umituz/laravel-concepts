                ...
                <table class=" table table-bordered table-striped table-hover datatable datatable-City">
                    ...
                    @foreach($cities as $key => $city)
                        <tr data-entry-id="{{ $city->id }}">
                            ...
                            <td>
                                @can('city_show')
                                    <a dusk="viewButton{{ $city->id }}" class="btn btn-xs btn-primary"
                                ...
                                @can('city_edit')
                                    <a dusk="editButton{{ $city->id }}" class="btn btn-xs btn-info" href="{{ route('admin.cities.edit', $city->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
                                ...
                                @can('city_delete')
                                    <form action="{{ route('admin.cities.destroy', $city->id) }}" method="POST"
                                        ...
                                        <input dusk="deleteButton{{ $city->id }}" id="delete{{$city->id}}" type="submit" class="btn btn-xs btn-danger"
