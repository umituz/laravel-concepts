            ...
            <div class="flex">
                ...
                <div class="ml-2 relative">
                    ...
                    <input type="text" name="search" placeholder="Search Facebook"
                           class="rounded-full w-56 bg-gray-200 h-8 focus:outline-none focus:shadow-outline text-sm pl-8">
                </div>
            </div>
        </div>
        <div class="w-1/3 flex justify-center items-center h-full">
            <router-link to="/" class="px-8 h-full flex items-center border-b-2 border-blue-500">
            ...
            <router-link :to="'/users/' + authUser.data.user_id" class="px-8 h-full flex items-center">
                <ProfilePhoto/>
            </router-link>
            <router-link to="/" class="px-8 h-full flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current w-5 h-5">
                    <path
