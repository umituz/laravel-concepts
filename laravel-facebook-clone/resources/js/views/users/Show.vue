    ...
    <div class="flex flex-col items-center" v-if="status.user === 'success' && user">
        <div class="relative mb-8">
            ...
            <div class="absolute flex items-center bottom-0 left-0 -mb-8 ml-12 z-20">
                <div class="w-32">
                    <img
                        src="https://avatars1.githubusercontent.com/u/22079280?s=460&u=cf9d1b9add8c7aab49b340ccd260f282c816a9fa&v=4"
            ...
            <div class="absolute flex items-center bottom-0 right-0 mb-4 mr-12 z-20">
                ...
                <button v-if="friendButtonText && friendButtonText === 'Accept'"
                        class="py-1 px-3 bg-blue-500 rounded"
                        @click="$store.dispatch('acceptFriendRequest',$route.params.userId)">
                    Accept
                </button>
                <button v-if="friendButtonText && friendButtonText === 'Accept'"
                        class="ml-2 py-1 px-3 bg-gray-400 rounded"
