 ...
 */
     ...
     */ 
         ...
         *
         * @return \AlternativeLaravelCache\Store\PredisCachePool|\AlternativeLaravelCache\Store\RedisCachePool|\AlternativeLaravelCache\Store\AbstractCachePool 
         * @static 
         */ 
        public static function wrapConnection()
        {
                        /** @var \AlternativeLaravelCache\Store\AlternativeRedisCacheStore $instance */
         ...
         *
         * @param array $tags
         * @return \AlternativeLaravelCache\Store\AlternativeRedisCacheStore 
         * @static 
         */ 
     ...
     */ 
        ...
        {            //Method inherited from \Illuminate\Queue\DatabaseQueue         
                        /** @var \App\Customizations\CustomDatabaseQueue $instance */
        ...
        {            //Method inherited from \Illuminate\Queue\Queue         
                        \App\Customizations\CustomDatabaseQueue::createPayloadUsing($callback);
        }
                    /**
     ...
     */ 
         ...
         * @static 
         */ 
        public static function errorJson($message = 'Default Message')
        {
                        return \Illuminate\Routing\ResponseFactory::errorJson($message);
        }
...
')
     ...
     */ 
         ...
         * 
         *
         * @see \App\Mixins\StrMixin::partNumber()
         * @param mixed $part
         * @static 
         */ 
        public static function partNumber($part)
        {
                        return \Illuminate\Support\Str::partNumber($part);
        }
                    /**
         * 
         *
         * @see \App\Mixins\StrMixin::prefix()
         * @param mixed $string
         * @param mixed $prefix
         * @static 
         */ 
        public static function prefix($string, $prefix = 'UZ-')
        {
                        return \Illuminate\Support\Str::prefix($string, $prefix);
        }
     ...
     */ 
         ...
         * 
         *
         * @see \App\Mixins\StatusMixin::error()
         * @static 
         */ 
        public static function error()
        {
                        return \App\Helpers\MacroHelper::error();
        }
                    /**
         * 
         *
         * @see \App\Mixins\StatusMixin::success()
         * @static 
         */ 
        public static function success()
        {
                        return \App\Helpers\MacroHelper::success();
        }
